                    ...
                    CHAR *CmdLine, INT ShowCmd )
{
  ...
  OD6_AnimAddUnit(OD6_ClockUnitCreate());
  OD6_AnimAddUnit(OD6_CubeUnitCreate());
  OD6_AnimAddUnit(OD6_CowUnitCreate());
  
  OD6_AnimAddUnit(OD6_InfoUnitCreate());
                                 ...
                                 WPARAM wParam, LPARAM lParam )
{
  ...
  case WM_CREATE:
    ...
    return 0;
  case WM_SIZE:
    OD6_AnimResize(LOWORD(lParam), HIWORD(lParam));
  case WM_TIMER:
    OD6_AnimRender();
    OD6_AnimCopyFrame();
    return 0;
